...
3. **Verify result:**
   ...
   - If BLOCKED or tests fail: discard worktree, revert any staged spec update for this file (`git checkout -- <spec_path>`). Report failure and **stop immediately**. Do not process remaining files.
